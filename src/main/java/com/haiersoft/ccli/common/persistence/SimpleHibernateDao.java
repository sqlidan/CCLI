...
public class SimpleHibernateDao<T, PK extends Serializable> {
	 ...
	 * @return
	 */
	public List<T> findBy(final Map<String,Object> params) {
	 ...
	 * @return SQLQuery
	 */
	public SQLQuery createSQLQuery(final String queryString, final Map<String, ?> params) {
		SQLQuery sqlQuery = getSession().createSQLQuery(queryString);
		if (!CollectionUtils.isEmpty(params)) {
			for (String param : params.keySet()) {
				sqlQuery.setParameter(param, params.get(param));
			}
		}
		return sqlQuery;
	}
	 ...
	 * @return
	 */
	public Map<String, Object> queryPageBySql(String sql, Integer pageIndex, Integer pageSize, Map<String, Object> params)  {
		...
		try {
			...
			totalCount = this.getCountBySql(sql, params);
			beginIndex = PageUtils.calBeginIndex(pageIndex, pageSize, totalCount);
		...
		returnMap.put("totalPage", PageUtils.calPageCount(totalCount, pageSize));
		return returnMap;
	}
	/**
	 * 获取记录条数
	 ...
	 */
	public int getCountBySql(String sql, final Map<String, Object> params)  {
		Session session = null;
		int totalCount = 0;
		try {
			session = this.getSession();
			...
			totalCount = ((BigDecimal) query.uniqueResult()).intValue();
		} catch (Exception e) {
			e.printStackTrace();
		}  
		return totalCount;
...
//	/**
//	 * 获取记录条数(bigInteger获取失败)
//	 * @param sql
//	 * @param params
//	 * @return
//	 * @throws BaseDaoException
//	 */
//	public int getCountBySql2(String sql, final Map<String, Object> params)  {
//		Session session = null;
//		int totalCount = 0;
//		try {
//			session = this.getSession();
