...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    private static String[] parsePatterns = {
            "yyyy-MM", "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy/MM/dd", "yyyy/MM/dd HH:mm:ss", "yyyy/MM/dd HH:mm"};
     ...
     *
     * @param date     日期
     * @param checkDay 客户的账单日
     */
    public static Date ifBillDay(Date date, Integer checkDay) {
        if (Integer.valueOf(formatDate(date, "dd")) < checkDay) {
            return date;
        } else {
