...
public class ApiPledgeTransferVO implements Serializable{
	...
	public Integer getWatchWeight() {
		return watchWeight;
	}
	public void setWatchWeight(Integer watchWeight) {
	...
	public String toString() {
		return "{ userNo=" + userNo + ", userName=" + userName
				+ ", watchAmount=" + watchAmount + ", watchWeight=" + watchWeight + ", order=" + order + ", result="
