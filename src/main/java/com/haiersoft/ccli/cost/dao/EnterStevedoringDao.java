...
@Repository
public class EnterStevedoringDao  extends HibernateDao<BisEnterSteveDoring, Integer> {
	...
	public void updateState2(String asn) {
		if(asn!=null && !"".equals(asn)){
			String sql="update bis_enter_stevedoring  set if_ok = '0',DROSTANINDBOOKIDS='' where asn_id = :asn";
			Map<String,Object> parme=new HashMap<String,Object>();
			parme.put("asn", asn);
			SQLQuery sqlQuery=createSQLQuery(sql, parme);
			sqlQuery.executeUpdate();
