...
public class PassPortDao extends HibernateDao<BisPassPort, String> {
    ...
    public List<Map<String,Object>> passButNotPassGate(String vehicleNo,String ioTypecd) {
        ...
        sql.append(" SELECT SEQ_NO,PASSPORT_NO,IO_TYPECD,VEHICLE_WT,VEHICLE_FRAME_WT,CONTAINER_WT,TOTAL_GROSS_WT,TOTAL_NET_WT,TOTAL_WT,PASSPORT_TYPECD,AREAIN_ETPS_NM ");
