...
/**
 * Created by galaxy on 2017/6/15.
 */
@Entity
@Table(name = "BIS_PRESENCE_BOX")
public class BisPresenceBox {
	@Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_PRESENCE_BOX")
	@SequenceGenerator(name = "SEQ_PRESENCE_BOX", sequenceName = "SEQ_PRESENCE_BOX", allocationSize = 1)
	...
	@Column(name = "IF_CD")
	private String ifCd="0";   //是否插电 0：否  1：是
	@Column(name = "CD_STATE")
	private String cdState="0";   //插电状态  0：未开始  1：开始插电  2：结束插电
	@Transient
