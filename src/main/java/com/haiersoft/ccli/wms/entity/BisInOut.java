 ...
 */
@Entity
@Table(name = "BIS_IN_OUT")
public class BisInOut {

	@Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IN_OUT")
	@SequenceGenerator(name = "SEQ_IN_OUT", sequenceName = "SEQ_IN_OUT", allocationSize = 1)
