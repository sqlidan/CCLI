...
public class PreEntryFTPUtils {

    private static final Logger logger= LoggerFactory.getLogger(FTPUtils.class);

    private static PreEntryFTPUtils ftpUtils;
...
//            rootDirectory ="/Send/"; //设置文件存放根目录
    ...
    //实例化对象
    public synchronized static PreEntryFTPUtils getInstance() {
        if (null == ftpUtils) {
            ftpUtils = new PreEntryFTPUtils();
        }
        return ftpUtils;
    }
