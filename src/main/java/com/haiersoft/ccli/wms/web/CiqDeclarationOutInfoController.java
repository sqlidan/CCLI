 ...
 * 
 * @author pyl
 * @ClassName: CiqDeclarationOutInfoController
 * @Description: 出库报检单明细Controller
 * @date 2016年3月3日 下午2:02:22
 */
@Controller
@RequestMapping("wms/ciqoutinfo")
public class CiqDeclarationOutInfoController extends BaseController{
