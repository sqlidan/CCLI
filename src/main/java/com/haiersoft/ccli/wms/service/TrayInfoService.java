...
public class TrayInfoService extends BaseService<TrayInfo, Integer> {
	 ...
	 * @return
	 */
	public List<Map<String,Object>> findTrayList(String ckId,String userid,String billNum,String ctnNum,String asn,String sku,String state,String sqlIf,String sqlOrd){
		return trayInfoDao.findTrayList(ckId,userid, billNum, ctnNum, asn,sku, state, sqlIf, sqlOrd);
	}
