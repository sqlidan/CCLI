 ...
 * 
 * @author Connor.M
 * @ClassName: SortingReportDao
 * @Description: 分拣报告书 DAO
 * @date 2016年4月25日 上午11:26:17
 */
@Repository
public class SortingReportDao extends HibernateDao<Stock, String>{
	
	
	/**
	 * 
	 * @author Connor.M
	 * @Description: 分拣报告书--普通
	 * @date 2016年4月25日 下午2:03:51 
	 * @param stock
	 * @return
	 * @throws
	 */
    ...
    public List<Map<String, Object>> searchSortingReport(Stock stock){
		...
		sb.append(" 			) AS original_piece_sum                      ");
		sb.append(" 		FROM                                             ");
		sb.append(" 			(                                            ");
		sb.append(" 				SELECT                                   ");
		sb.append(" 					a.asn,                               ");
	 ...
	 * 
	 * @author Connor.M
	 * @Description: 分拣报告书--日本
	 * @date 2016年4月26日 上午11:04:42 
	 * @param stock
	 * @return
	 * @throws
	 */
	 ...
	 * 
	 * @author Connor.M
	 * @Description: 分拣报告书--OTC
	 * @date 2016年4月26日 下午1:43:45 
	 * @param stock
	 * @return
	 * @throws
	 */
