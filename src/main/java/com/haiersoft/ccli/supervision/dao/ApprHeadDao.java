...
@Repository
public class ApprHeadDao extends HibernateDao<ApprHead, String> {
	...
	public void updateArrpIdbyId(String apprId, String localStatus,String id) {
		...
		String sql = "update FLJG_APPR_HEAD set APPR_ID = :apprId, LOCAL_STATUS = :localStatus, STATUS = :localStatus where ID = :id ";
