...
<div id="tb" style="padding:5px;height:auto">
	<div>
		<form id="searchFrom" action="" method="post">
	        ...
	        <select id="locationType" name="locationType" class="easyui-combobox" data-options="width:80,prompt: '类型'">
...
$(function(){   
	//客户
       ...
       dg = $('#dg').datagrid({
           method: "get",
           url: '${ctx}/report/stock/companyReport',
           fit: true,
           fitColumns: false,
           border: false,
           queryParams:obj,
           ...
           columns: [[
               ...
               {field: 'reportType', title: '类型', sortable: true, width: 70,
               ...
               {field: 'clientName', title: '存货方', sortable: true, width: 150},
               {field: 'clientId', title: '存货方ID', sortable: true, width: 70},
               {field: 'shf', title: '收货方', sortable: true, width: 200},
               {field: 'billCode', title: '提单号', sortable: true, width: 100},
               {field: 'companyName', title: '报关企业', sortable: true, width: 150},
               {field: 'companyNum', title: '报关数量', sortable: true, width:60},
               {field: 'ciqName', title: '报检企业', sortable: true, width: 150},
               {field: 'ciqNum', title: '报检数量', sortable: true, width: 60},
               {field: 'orgName', title: '费用结算客户', sortable: true, width:150},
               {field: 'spNum', title: '审批数量', sortable: true, width: 60},
               {field: 'remark', title: '备注', sortable: true, width:200},
               {field: 'createUser', title: '所属客服', sortable: true, width:60}
           ]],
...
function report(){
	if ($("#searchFrom").form('validate')) {
		var url = "${ctx}/report/stock/companyExcel";
...
function reportpdf(){
	if ($("#searchFrom").form('validate')) {
		var url = "${ctx}/report/stock/companyPdf";
		var billNum=$("#searchItemNum").val();
	 	$("#searchFrom").attr("action",url).submit();
	}
}
