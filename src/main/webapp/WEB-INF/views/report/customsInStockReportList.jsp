...
$(function(){   
	dg = $('#dg').datagrid({    
		method: "get",
	    url:'${ctx}/report/customsInStock/json', 
	    fit : true,
		fitColumns : true,
		border : false,
// 		idField : 'trayCode',
	    ...
	    columns:[[    
	        ...
	        {field: 'declareTime',title:'申报日期',sortable:true,width:100},
	        {field: 'cdNum',title:'报关单号',sortable:true,width:100},
	        {field: 'netWeight',title:'净重（KG）',sortable:true,width:100},
	        {field: 'totalPrices', title:'货值（美元）', sortable:true, width:100},
	        {field: 'verifinum', title:'核销单号', sortable:true, width:100},
...
function dc(){
	var url = "${ctx}/report/customsInStock/exportCustomsInStockExcel";
