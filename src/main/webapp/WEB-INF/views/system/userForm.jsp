	...
	<form id="mainform" action="${ctx }/system/user/${action}" method="post">
		<table class="formTable">
			...
			<tr>
				<td>编码：</td>
				<td>
					<input id="userCode" name="userCode" class="easyui-validatebox" data-options="width: 150,required:'required',validType:'length[3,3]'" value="${user.userCode }"> 
				</td>
			</tr>
			<tr>
				<td>姓名：</td>
				<td><input name="name" type="text" value="${user.name }" class="easyui-validatebox" data-options="width: 150,required:'required',validType:'length[1,10]'"/></td>
			</tr>
			<tr>
				<td>出生日期：</td>
			...
			<tr>
				<td>工号：</td>
				<td><input type="text" name="workNo" value="${user.workNo }" class="easyui-numberbox"  data-options="width: 150 ,required:'required'" /></td>
			</tr>			
			<tr>
				<!--<td>描述：</td>-->
