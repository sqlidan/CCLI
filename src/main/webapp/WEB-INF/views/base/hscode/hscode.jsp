...
<div style="padding:5px;height:auto" id="tb">
    <form id="searchFrom" action="">
        ...
        <input type="text" name="filter_LIKES_code" class="easyui-validatebox" data-options="width:150,prompt: 'HS编码'"/>
...
<script type="text/javascript">
    ...
    function gridDG() {
        dg = $('#dg').datagrid({
            ...
            columns: [[
                ...
                {field: 'code', title: 'HS编码', sortable: true, width: 20},
                {field: 'itemNum', title: '单位代码', sortable: true, width: 20},
    ...
    function del() {
        ...
        parent.$.messager.confirm('提示', '删除后无法恢复您确定要删除？', function (data) {
            if (data) {
                $.ajax({
                    type: 'get',
                    url: "${ctx}/base/hscode/delete/" + row.id,
    ...
    function update() {
        ...
        d = $("#dlg").dialog({
            ...
            width: 380,
            height: 380,
            href: '${ctx}/base/hscode/update/' + row.id,
            maximizable: true,
            modal: true,
            buttons: [{
                text: '确认',
