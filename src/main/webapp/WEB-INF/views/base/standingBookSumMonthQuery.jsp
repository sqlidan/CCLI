    ...
    <div>
        <form id="searchFrom" action="" method="post">
            ...
            <input type="text" name="feeName" class="easyui-validatebox"
                   data-options="width:250,prompt: '费目名称'"/>
        ...
        <shiro:hasPermission name="bis:checkbook:summonthreport">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        dg = $('#dg').datagrid({
            method: "get",
            url: '${ctx}/cost/standingBook/listsummonthjson',
            fit: true,
            fitColumns: false,
            border: false,
            sortOrder: 'desc',
    ...
    function report() {
    	if ($("#searchFrom").form('validate')) {
	        var url = "${ctx}/cost/standingBook/exportExcel";
