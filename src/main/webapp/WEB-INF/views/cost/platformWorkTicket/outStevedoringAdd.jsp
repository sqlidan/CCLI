...
<body>
<div>
	<form id="mainform" action="${ctx}/cost/outNotPaid/${action}" method="post">
	...
	$.ajax({
		...
		success: function(msg){
			if(msg != null && msg!=""){
				...
				$("#netW").val(Number(msg[5])/1000);
				$("#loadingNume").val(msg[1]);
				$("#droLoadingTime").val( msg[3] );
				$("#droStockIdName").val(msg[2]);
				$("#droStockId").val(msg[6]);
				$("#ifAllMan").click();
