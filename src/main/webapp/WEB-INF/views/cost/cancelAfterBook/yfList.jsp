        ...
        <div>
        	<form id="searchFrom" action="">
       	        <select class="easyui-combobox" id="receiver" name="receiver" data-options="width:150,prompt:'客户',required:'required' ,">
       	         ...
       	         <select class="easyui-combobox" id="ngz" name="ngz" data-options="width:150,prompt:'查询类型',required:'required' ,">
...
$(document).ready(function(){
	dg=$('#dg').datagrid({    
		method: "get",
	    url:'${ctx}/cost/cancelafter/listjson/2', 
	    fit : true,
		fitColumns : true,
		border : false,
		idField : 'IDS',
	    ...
	    columns:[[
	        ...
	        {field:'YSZ',title:'应付RMB',sortable:true,width:100},
	        {field:'YS',title:'实付RMB',sortable:true,width:100},
	        {field:'WS',title:'未付RMB',sortable:true,width:100}
	...
	function openVerifi(ctype) {
		...
		if(true==iscx ){
			...
			d = $("#dlg").dialog({
				...
				width : 450,
				height : 450,
				href : '${ctx}/cost/cancelafter/open/2/'+ctype,
				maximizable : true,
				modal : true,
				buttons : [ {
					text : '确认',
