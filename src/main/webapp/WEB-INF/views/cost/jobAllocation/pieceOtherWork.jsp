...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        dg = $('#dg').datagrid({
            method: "get",
            url: '${ctx}/cost/piecework/otherWorkList',
            fit: true,
            fitColumns: true,
            border: false,
            idField: 'id',
            ...
            columns: [[
                ...
                {field: 'workerName', title: '人员',width: 100},
                {field: 'workerTypeName', title: '作业类型', sortable: true, width: 150},
...
function selBigType(){
    ...
    function add(title, href,version) {
    	if(typeof(href) =='undefined'){
			title="杂项作业添加";
			href='${ctx}/cost/piecework/createOtherWork';
			version="create";
		}
        d = $("#dlg").dialog({
            title: title,
    ...
    function upd() {
        ...
        var href = '${ctx}/cost/piecework/updateOtherWork/' + row.id;
        add("杂项作业管理", href,"update");
    }
       ...
       var rows = dg.datagrid('getSelections');
        ...
        parent.$.messager.confirm('提示', '删除后无法恢复您确定要删除？', function (data) {
            if (data) {
                $.ajax({
                    type: 'get',
                    url: "${ctx}/cost/piecework/deleteOtherWork/" + ids,
