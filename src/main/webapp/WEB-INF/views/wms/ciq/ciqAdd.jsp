...
<body>
<div>
	<form id="mainform2" action="${ctx}/wms/ciqinfo/${action}" method="post">
		...
		<table class="formTable">
			...
			<tr>
				...
				<c:choose>
					...
					<c:otherwise>
						<td><input id="infoMan" name="recordMan" value="${bisCiqInfo.recordMan}" class="easyui-validatebox" data-options="width: 150"  disabled/></td>
					</c:otherwise>
			</c:choose>
			</tr>
			<tr>
