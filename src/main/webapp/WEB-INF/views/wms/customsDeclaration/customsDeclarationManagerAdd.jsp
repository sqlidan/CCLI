	...
	<form id="mainForm"   method="post">
		...
		<table class="formTable" >
			<tr>
				...
				<td>申报日期：</td>
				<td>
					<input id="sbTime" name="sbTime" class="easyui-my97" data-options="width:180" datefmt="yyyy-MM-dd HH:mm:ss"  />
				</td>
				<td>提运单号：</td>
				<td>
			...
			<tr>
				...
				<td>发货人：</td>
				<td>
					<input type="text" id="consignor" name="consignor" class="easyui-validatebox"  data-options="width: 180"  maxlength="50" >
				</td>
				<td>贸易国：</td>
				<td>
					<input type="text" id="myg" name="myg" class="easyui-validatebox" data-options="width: 180"    maxlength="50" >
				</td>
				<td>启运国：</td>
				<td>
					<input type="text" id="qyg" name="qyg" class="easyui-validatebox" data-options="width: 180"  maxlength="50" >
				</td>
			</tr>
		</table>
	</form>
		...
		if($("#mainForm").form('validate')){
			if(a == 0){
				...
				$.ajax({
					async: false,
					type: 'POST',
					url: "${ctx}/wms/customsDeclaration/create",
