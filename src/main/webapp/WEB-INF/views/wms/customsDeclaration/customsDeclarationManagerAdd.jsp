					...
					<tr>
						...
						<td>
							<input type="text" id="accountBook" name="accountBook" class="easyui-validatebox"
								   data-options="width:180, required:'required'" value="${bisPreEntryInfo.accountBook}">
						</td>
		...
		<div data-options="region:'south',split:true,border:false" title="列表" style="height:600px">
			<div id="tb2" style="padding:5px;height:auto" class="datagrid-toolbar">
				<div>
					...
					<shiro:hasPermission name="wms:customsDeclarationInfo:copy">
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"
...
<script type="text/javascript">
	...
	function copyInfo() {
		...
		$("#xh").val(copy.xh);
		$("#accountBook").val(copy.accountBook);
		$("#spbh").val(copy.spbh);
		$("#spmc").val(copy.spmc);
		$("#ggxh").val(copy.ggxh);
		$("#sbsl").val(copy.sbsl);
