           ...
           <!--  <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="warehouse" id="warehouse" class="easyui-validatebox"
                           data-options="width:200,prompt: '仓库名'"/>
                </td> -->
            </tr>
            <!-- <tr>
                </td>
                ...
                <td><input type="text" name="cargoName" id="cargoName" class="easyui-validatebox"
                           data-options="width:200,prompt: '产品名'"/></td>
            </tr>
            <tr>
                <td>件数</td>
                <td><input type="text" name="inspectTotal" id="inspectTotal" class="easyui-validatebox"
                           data-options="width:200,prompt: '件数', required:'required'"/>
                </td>
            </tr> -->
            <tr>
                <td>状态</td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if ($("#inspectId").val() == "") {
            ...
            $.ajax({
                async: false,
                type: "POST",
                url: "${ctx}/wms/inspect/plans/getNewInspectId",
                data: "",
                dataType: "text",
	...
	////$('#stockName').combobox('getText')
    var stockNameFlag = document.getElementById("stockName").value;//.text;//options[document.getElementById("stockName").selectedIndex].value;
	...
	//保存方法 添加状态的验证，在下边表格的确认添加是否保存的验证。
    function submitForm() {
