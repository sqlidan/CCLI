...
<div data-options="region:'center'" title="预报单添加" style="overflow-y:auto">
	...
	<table class="formTable" >
		<tr>
			...
			<td>服务项目：</td>
			<td>
				<select id="serviceProject" name="serviceProject" class="easyui-combobox" data-options="width: 180, required:'required'" editable="false">
...
<%--					</select>--%>
					<input id="clientName" name="clientName" type="text" class="easyui-validatebox"  data-options="width:180">
				</td>
			<td>报关公司：</td>
				<td>
...
<%--					</select>--%>
					<input id="declarationUnit" name="declarationUnit" type="text" class="easyui-validatebox"  data-options="width:180">
				</td>
		</tr>
		<tr>
			<td>贸易方式：</td>
			...
			<td>提单号：</td>
				<td>
					<input id="billNum" name="billNum" type="text" class="easyui-validatebox"  data-options="width:180, required:'required'" maxlength="17"  >
				</td>
			<td>品名：</td>
				<td>
					<input id="productName" name="productName" type="text" class="easyui-validatebox"  data-options="width:180, required:'required'" maxlength="100" >
				</td>
			<td>HS编码：</td>
				<td>
					<input id="hsNo" name="hsNo" type="text" class="easyui-validatebox"  data-options="width:180, required:'required'" maxlength="100" >
				</td>
		</tr>
		<tr>
			<td>件数：</td>
				<td>
					<input type="text" id="price" name="price" class="easyui-validatebox"  data-options="width: 180, required:'required'" maxlength="10" oninput="ischeckNum(this)" onpropertychange="ischeckNum(this)">
				</td>
			<td>重量：</td>
				<td>
					<input id="netWeight" name="netWeight" class="easyui-validatebox" data-options="width: 160, required:'required'"  maxlength="10" onkeyup="ischeckNum(this)">
					<span style="color: red">KG</span>
				</td>
			<td>收货人</td>
				<td>
					<input id="consignee" name="consignee" class="easyui-validatebox" data-options="width: 180, required:'required'"  maxlength="50">
				</td>
			<td>发货人</td>
				<td>
					<input id="consignor" name="consignor" class="easyui-validatebox"  data-options="width: 180, required:'required'" maxlength="50"/>
				</td>
		</tr>
		<tr>
			<td>原产国</td>
				<td>
					<input id="contryOragin" name="contryOragin" class="easyui-validatebox" data-options="width: 180, required:'required'"  maxlength="50"/>
				</td>
		</tr>
	</table>
</form>
