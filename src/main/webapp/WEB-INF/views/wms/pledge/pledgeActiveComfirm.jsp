	...
	<div>
		<form id="searchFrom" action="">
      	    ...
      	    <select id="filter_STATE" name="filter_STATE" class="easyui-combobox"
                ...
                <option value='2'>动态质押</option>
                <option value='3'>动态解押</option>
            </select>
	...
	dg=$('#dg').datagrid({    
	    ...
	    columns:[[
	    	...
	    	{field: 'TREND_ID', title: '质押编号', sortable:true,width:100},
 	        ...
 	        {field:'CUSTOMER_CODE',title:'货主账号',sortable:true,width:100},
 	        {field:'CUSTOMER_NAME',title:'货主名称',sortable:true,width:100},
 	        ...
 	        {field:'CLIENT_NAME',title:'客户名称',sortable:true,width:100},
