    ...
    $(function () {
        ...
        dg = $('#dg').datagrid({
            ...
            columns: [[
                ...
                {field: 'hsItemName', title: '海关品名', sortable: true, width: 150},
                {field: 'piece', title: '箱属(合计)', sortable: true, width: 125},
                ...
                {
                    field: 'isSend', title: '是否发送BSL', sortable: true,
                ...
                {field: 'customsCompany', title: '报关代理公司', sortable: true, width: 225},
                {
                ...
                {field: 'ciqCompany', title: '报检代理公司', sortable: true, width: 225},
                ...
                {
                    field: 'ifMacAdmit', title: '是否MSC认证', sortable: true,
                    formatter: function (value, row, index) {
                        return value == "0" ? '否' : '是';
                    }
                }
